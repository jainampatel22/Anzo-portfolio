...
<div className='h-screen p-5'>
    ...
    <h1 className='font-[anzo1] text-[10vw] md:text-[17vw] text-gray-400 absolute -top-12 left-12 tracking-wide'>HOW </h1>
    <h1 className='font-[anzo1] text-[10vw] md:text-[17vw] text-white absolute top-[25%] left-12 tracking-wide'>CAN</h1>
      <h1 className='font-[anzo1] text-[10vw] md:text-[17vw] text-white absolute -top-12 left-[70%] tracking-wide'>I HELP </h1>
      <h1 className='font-[anzo1] text-[10vw] md:text-[17vw] text-white absolute top-[25%] left-[75%] tracking-wide'>YOU</h1>
    <p className='  md:text-[1.5vw] text-[0.6vw] font-[anzo5] text-white top-[65%] absolute left-[37%] tracking-wide leading-6'><span className='font-[anzo5] text-gray-400'> I am a self-taught web and brand <br />designer with a passion for creating <br /> unique and timeless</span>  masterpieces for <br /> ambitious professionals, entrepreneurs, <br /> artists, and boutique businesses. <br />
​
